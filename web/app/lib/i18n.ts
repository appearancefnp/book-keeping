export const EN = {
  ...
  'login.failed': 'Sign-in failed. Check your email, password and code.', 'login.back': 'Back',
  'a11y.language': 'Language', 'a11y.mainNav': 'Main navigation', 'a11y.dismiss': 'Dismiss',
...
export const LV: Record<keyof typeof EN, string> = {
  ...
  'login.failed': 'Pieteikšanās neizdevās. Pārbaudiet e-pastu, paroli un kodu.', 'login.back': 'Atpakaļ',
  'a11y.language': 'Valoda', 'a11y.mainNav': 'Galvenā navigācija', 'a11y.dismiss': 'Aizvērt',
...
export const RU: Record<keyof typeof EN, string> = {
  ...
  'login.failed': 'Не удалось войти. Проверьте почту, пароль и код.', 'login.back': 'Назад',
  'a11y.language': 'Язык', 'a11y.mainNav': 'Основная навигация', 'a11y.dismiss': 'Закрыть',
