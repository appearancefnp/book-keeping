...
M7 (credit notes) is done (✅, shipped 2026-07-17); M4 (AR lifecycle, 🔶) rounds out invoicing —
C-recurring and slice D (quotes→invoice, customer statements) remain. M8–M13 follow the spec's
